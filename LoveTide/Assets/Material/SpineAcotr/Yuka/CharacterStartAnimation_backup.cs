...
public class CharacterStartAnimationa : MonoBehaviour
{
    ...
    [SpineAnimation] public string eyebrowIdleAnimation = "Eyebrow_A";
    ...
    private void OnStart()
    {
        ...
        state.SetAnimation(3, eyebrowIdleAnimation, true);
        state.SetAnimation(4, facIdleAnimation, true);
    }
}
